...
public class OpenPlatformXiaochengxuService {
	@Autowired
	private OpenPlatformXiaochengxuRepository openPlatformXiaochengxuMapper;
	/**
	 * 查询可以绑定的小程序
	 * @return
	 */
	public OpenPlatformXiaochengxu findCanBindXiaochengxu(){
		List<OpenPlatformXiaochengxu> openPlatformXiaochengxus = openPlatformXiaochengxuMapper.findByTopLimitAndIsValidateAndType("0","1","1");
